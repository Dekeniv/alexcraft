        ...
        <div class="secondMain">
            <div class="divWhite container80">
                <section>
                    ...
                    <h1>
                    <strong class="bold">Alexcraft</strong> vous propose ses services dans l’<strong class="bold">achat</strong>, l’<strong class="bold">installation</strong> et le <strong class="bold">dépannage</strong> de :
                    </h1>
                    <p>
